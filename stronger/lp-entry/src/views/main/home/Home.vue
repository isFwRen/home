<template>
  <div class="lp-home">
      ...
      <div class="myAim">
        ...
        <div class="content">
          <div class="todayYield">
            ...
            <span>{{
              sayArr[yeild.aimYeild] ||
                sayArr[yeild.nowYeild > yeild.aimYeild]
            }}</span>
          </div>
    ...
    <ShowRule ref="ShowRules" 
    @showDetial="watchDetial"/>
    <ShowNotice ref="ShowNotice" 
    @showDetial="watchDetial"/>
    <WatchDialogVue
      :content="DetialContent"
      ref="showWatchDialog"
    />
    <Ranking
    ref="showRanking"
...
<script>
  ...
  import WatchDialogVue from './WatchDialog.vue'
    ...
    methods: {
      ...
      setTreeData(list) {
        ...
        list.forEach(e => {
          ...
          treeData.X.unshift(
            date[moment(e.yieldDate).format('d')]
          )
          Number.push(e.value)
        })
        Number.sort((a, b) => b - a)
