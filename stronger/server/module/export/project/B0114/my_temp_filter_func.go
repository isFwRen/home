...
func b0114TempFilterFunc(in, param *pongo2.Value) (*pongo2.Value, *pongo2.Error) {
	//global.GLog.Info("B0114:::MyTempFilterFunc")
...
func TempRender(export model.SysExport) (err error, tpl *pongo2.Template) {
	if !pongo2.FilterExists("B0114FilterFunc") {
		err = pongo2.RegisterFilter("B0114FilterFunc", b0114TempFilterFunc)
		if err != nil {
			return err, tpl
		}
	}
