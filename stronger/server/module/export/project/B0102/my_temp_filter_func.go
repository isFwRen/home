...
func B0102TempFilterFunc(in, param *pongo2.Value) (*pongo2.Value, *pongo2.Error) {
	//global.GLog.Info("B0102:::MyTempFilterFunc")
...
func TempRender(export model.SysExport) (err error, tpl *pongo2.Template) {
	if !pongo2.FilterExists("B0102FilterFunc") {
		err = pongo2.RegisterFilter("B0102FilterFunc", B0102TempFilterFunc)
		if err != nil {
			return err, tpl
		}
	}
