...
import "server/module/pro_conf/model"

type ProjectConfigAgingHoliday struct {
	InquireStartDate string `json:"inquireStartDate" example:"202101"` //起始时间
	InquireEndDate   string `json:"inquireEndDate" example:"202103"`   //结束时间
}

type ProjectConfigAgingHolidayInsertDetailArr struct {
	ProjectConfigAgingHolidayInsertDetail []model.SysProjectConfigAgingHoliday `json:"projectConfigAgingHolidayInsertDetail"`
}

type ProjectConfigAgingHolidayUpdateDetailArr struct {
	ProjectConfigAgingHolidayUpdateDetail []model.SysProjectConfigAgingHoliday	`json:"projectConfigAgingHolidayUpdateDetail"`
}

type InsertProjectConfigAgingHoliday struct {
