...
func FetchBill(projectBill model.ProjectBill) (error, model.ProjectBill) {
	...
	localFile := projectBill.DownloadPath + projectBill.Files[0]
	cmd := fmt.Sprintf(global.GProConf[global.GConfig.System.ProCode].DownloadPaths.FetchBill, projectBill.Files[0], localFile)
