<template>
	<lp-dialog ref="dialog" title="修改密码" width="600" @dialog="handleDialog">
		<div slot="main">
			<ul class="mt-4">
				<li class="mb-1">
					<z-text-field
				...
				<li class="mb-1">
					<z-text-field
						...
						:validation="[
							...
							{
								regex: regex_newpassword_digital,
								message:
									'输入不符合密码为数字，字母和符号的组合，长度为9-16位要求的密码'
							}
